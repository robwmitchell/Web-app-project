...
const ServiceRadar = ({
  ...
  // Process services for radar display - show all selected services, highlight those with issues
  ...
  }, [radarServices, radarConfig, highlightedService]);
            ...
            <div className="radar-services-grid">
              {radarServices.map((service) => (
                <div
                  ...
                  } ${highlightedService === service.id ? 'highlighted' : ''}`}
